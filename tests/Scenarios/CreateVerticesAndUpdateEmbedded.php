 ...
 */
class CreateVerticesAndUpdateEmbedded extends AbstractScenario
{
    protected static $description = 'it creates (C) vertices and updates (U) using an embedded retrieve (R)';
